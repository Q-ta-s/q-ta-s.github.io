...
zxx_ext = {
    "ARCADE": "zfb", "FC": "zfc", "GB": "zgb", "GBC": "zgb", "GBA": "zgb", "MD": "zmd", "SFC": "zsf", "PCE": "zpc"
}
supported_img_ext = [
    "png", "jpg", "jpeg", "gif"
]
...
def process_sys(drive, system, test_mode):
    ...
    if not os.path.isdir(roms_path):
        ...
        print("  Check the provided path points to SD card!")
        raise StopExecution
...
def run():
    ...
    while not drive or not os.path.isdir(drive):
        ...
        print()
        print("Please enter the drive or path where your SD card is located e.g. F:")
        drive = input()
