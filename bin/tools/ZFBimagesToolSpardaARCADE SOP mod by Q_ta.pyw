...
class Application(tk.Frame):
    ...
    def __init__(self, master: tk.Tk = None):
        ...
        self.create_zfb_button = tk.Button(self.frame, text="Create ZFB Files", command=self.create_zfb_files,
                                           font=("Helvetica", 14))
        self.create_zfb_button.grid(row=5, column=0, sticky="w", columnspan=5, pady=8)

    #--- Q_ta mod ------------------------------------------------------------------
        # Padding, Message Label
        self.padding_label = tk.Label(self.frame, text="", font=label_font, width=26)
        ...
        self.msg_label.grid(row=6, column=0, sticky="w")

        # Image Size - Label
        self.imgwidth_label = tk.Label(self.frame, text="Image Size: ", font=label_font)
        self.imgwidth_label.grid(row=3, column=0, sticky="w")
        self.imgheight_label = tk.Label(self.frame, text=" x ", font=label_font)
        self.imgheight_label.grid(row=3, column=2, sticky="w")
        ...
        self.imgwidth_entry.grid(row=3, column=1, sticky="w")
        ...
        self.imgheight_entry.grid(row=3, column=3, sticky="w")
...
root.title("ZFBSpardaToolARCADE SOP [mod by Q_ta]")
